		...
		<div class="column_right">
				...
				<ul class="dot">
					...
					<{ section name=col loop=$articles }>
						<li>
							<span class="col1"><a href="<{$app}>/article/index/aid/<{ $articles[col].id }>" title="<{ $articles[col].title }>"><{ $articles[col].title|truncate:25 }></a></span>							     		     			  <span class="col2"><a style="background:url();padding:0px;" href="<{$app}>/user/index/uid/<{$articles[col].uid}>"><{ $articles[col].author|truncate:9 }></a></span>
